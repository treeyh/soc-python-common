...
exportDsConfig: List[config_model.DataSourceConfig] = [
    ...
    config_model.DataSourceConfig(dsType=DsMysql, host='192.168.80.129', port=33310, db='soc_word_db',
                                  user='root', passwd='192.168.80.129', includes=['soc_word_db'], excludes=[], name='MySql测试导出数据库', code='Mysql-export', comment='MySql测试导出数据库'),
