...
# 请求的URL，WebHook地址
    ...
    webhook = "https://oapi.dingtalk.com/robot/send?access_token=66f560a136bec89f2cf6c1f893cab27ae842b4c77e099ee1bef46ed9f34f2556&timestamp={}&sign={}".format(timestamp, sign)
#构建请求头部
    header = {
